...
public class ResponseService {
      ...
      private ResponseFromComPort byteArrToGetConverterType(byte[] data) {
            ...
            HexByteData dataDeviceType = new HexByteData(data[4], HexByteType.DEVICE_TYPE);
            dataList.add(dataDeviceType);
            HexByteData dataSerialId0 = new HexByteData(data[5], HexByteType.SERIAL_ID_B0);
            dataList.add(dataSerialId0);
            HexByteData dataSerialId1 = new HexByteData(data[6], HexByteType.SERIAL_ID_B1);
            dataList.add(dataSerialId1);
            HexByteData dataSerialId2 = new HexByteData(data[7], HexByteType.SERIAL_ID_B2);
            dataList.add(dataSerialId2);
            HexByteData dataSerialId3 = new HexByteData(data[8], HexByteType.SERIAL_ID_B3);
            dataList.add(dataSerialId3);
            HexByteData dataSerialId4 = new HexByteData(data[9], HexByteType.SERIAL_ID_B4);
            dataList.add(dataSerialId4);
            HexByteData dataSerialId5 = new HexByteData(data[10], HexByteType.SERIAL_ID_B5);
            dataList.add(dataSerialId5);
            HexByteData dataSerialId6 = new HexByteData(data[11], HexByteType.SERIAL_ID_B6);
            dataList.add(dataSerialId6);
            HexByteData dataSerialId7 = new HexByteData(data[12], HexByteType.SERIAL_ID_B7);
            dataList.add(dataSerialId7);
            HexByteData dataHwVersion = new HexByteData(data[13], HexByteType.HW_VERSION);
            dataList.add(dataHwVersion);
            HexByteData dataSwVersionLo = new HexByteData(data[14], HexByteType.SW_VERSION_LO);
            dataList.add(dataSwVersionLo);
            HexByteData dataSwVersionHi = new HexByteData(data[15], HexByteType.SW_VERSION_HI);
